...
def rescue_fragmented_bins(
    ...
    current_valid_bins = clusters_df[clusters_df['cluster'] != 'noise']['cluster'].unique()
    ...
    logger.info(f"Singleton Rescue complete: Assigned {rescued_singletons} contigs to existing bins.")
