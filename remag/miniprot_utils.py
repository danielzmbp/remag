...
def estimate_organisms_from_all_contigs(fragments_dict, args, query_coverage_threshold=0.4, identity_threshold=0.5):
    """
    ...
    Args:
        ...
        query_coverage_threshold: Minimum query coverage for alignments (protein coverage) (default: 0.4)
        identity_threshold: Minimum identity for alignments (default: 0.5)
...
def parse_and_cache_paf_files(temp_dir, filtered_clusters, args,
                            query_coverage_threshold=0.4, identity_threshold=0.5):
    """
...
def check_core_gene_duplications(clusters_df, fragments_dict, args,
    ...
    Args:
        ...
        fragments_dict: Dictionary mapping headers to sequences
        args: Arguments object containing output directory, cores, etc.
        query_coverage_threshold: Minimum query coverage (protein coverage) (default: 0.4)
        identity_threshold: Minimum identity (default: 0.5)
