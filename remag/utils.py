...
def select_min_contig_length(fasta_file, coverage_count=0):
    """Choose admission and fragment length using coverage count and assembly."""
    ...
    minimum = 1000 if coverage_count == 1 or median_length < 2500 else 4096
